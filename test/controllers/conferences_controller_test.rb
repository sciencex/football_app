...
class ConferencesControllerTest < ActionController::TestCase
  ...
  test "should create conference" do
    assert_difference('Conference.count') do
      post :create, conference: { abbreviation: @conference.abbreviation, name: @conference.name }
    end
  ...
  test "should update conference" do
    patch :update, id: @conference, conference: { abbreviation: @conference.abbreviation, name: @conference.name }
    assert_redirected_to conference_path(assigns(:conference))
  end
